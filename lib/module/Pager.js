...
import { StyleSheet, TextInput, Keyboard, I18nManager, InteractionManager, Text } from 'react-native';
...
export default class Pager extends React.Component {
  ...
  render() {
    ...
    const animatedView = children => /*#__PURE__*/React.createElement(Animated.View, {
    ...
    }, /*#__PURE__*/React.createElement(Text, null, "Hello Test"), children));

    const contentView = children => {
      return swipeEnabled && this.state.enabled ? /*#__PURE__*/React.createElement(PanGestureHandler, _extends({
      ...
      }, gestureHandlerProps), animatedView(children)) : animatedView(children);
    };
    ...
    return children({
      ...
      jumpTo: this.jumpTo,
      render: children => contentView(children)
    });
  }
