...
class Pager extends React.Component {
  ...
  render() {
    ...
    const animatedView = children => /*#__PURE__*/React.createElement(_reactNativeReanimated.default.View, {
    ...
    }, /*#__PURE__*/React.createElement(_reactNative.Text, null, "Hello Test"), children));

    const contentView = children => {
      return swipeEnabled && this.state.enabled ? /*#__PURE__*/React.createElement(_reactNativeGestureHandler.PanGestureHandler, _extends({
